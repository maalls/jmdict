...
use App\Entity\Base;
use App\Entity\Word;
use App\Entity\KanjiReading;
use App\Entity\Sense;
use App\Entity\SenseGlossary;
use App\Entity\SenseReference;
use App\Entity\SenseSource;
use App\Entity\SenseWord;
...
class LoadDatabaseCommand extends Command
{
    ...
    function loadCrossReferences($output)
    {
        ...
        $q = $this->em->createQuery('delete from App\Entity\SenseReference sr where sr.id <> 0');
    ...
    function loadWords($output) 
    {
        ...
        $q = $this->em->createQuery('delete from App\Entity\Base b where b.id <> 0');
        $numDeleted = $q->execute();
